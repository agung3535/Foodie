...
struct NetworkService {
    ...
    func fetchCategoriesDish(catId: String, completion: @escaping(Result<[Dish], Error>) -> Void) {
        request(route: .fetchCategoryDishes(catId), method: .get, completion: completion)
    }
